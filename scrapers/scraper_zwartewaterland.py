...
url = "https://www.zwartewaterland.nl/rss/content-list?type%5B%5D=vacancy&sort_by=published_at&sort_order=DESC"  # replace with actual RSS feed URL
...
def run(playwright: Playwright) -> None:
    ...
    for item in feed.entries:
        ...
        jobTitle = item.title
        employer = 'Gemeente Zwartewaterland'
        jobText = page.locator('article.main-content').text_content()
        jobUrl = item.link
        source = 'Gemeente Zwartewaterland'
